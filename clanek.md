...
- In the first step, after randomly selecting the dimension $d=0$ and split_point s as in (x = rovnice s půlením nahoře) $s = 300$, the point fits into the possibilty space of the left vertex $\langle 170.06) \times \langle 238.62)$. 
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbODQ3MTYzNTgzLC0yMzIyNDYzNywtMTM1Mj
