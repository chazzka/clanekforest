...
In each construction step, random feature of a datapoint is selected. With the feature selected, we obtain its previously assigned range. 
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbNjE0ODc1MDY0LDExMDkyODUyMDYsMjEwMT
