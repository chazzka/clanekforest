...
Then we obtain the left and right hyperrectangles $R_l$, $R_r$ and  $$R_l = r_1 \times  \cdots \times r_{d-1} \times  r_l \times r_{d+1} \times \cdots \times r_n  \tag{x}$$
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTEyMzAxODA0MzYsLTE0OTgwMTkzNzAsLT
