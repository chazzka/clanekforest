...
As we can see, the theoretical novelty observations get assigned the same *path_length* as a priory known, regular observations.
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbMjAzODY3MzA5MCwyMDk2ODY5MzcxLC0xMT
