...
For each $i \in\{1, \dots, n\}$, feature $f_i$ is bounded by the range $r_i$. The ranges form the observed space $R$ as in (xx).
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbMTA0Nzk1ODE2OCwxMDUyNzc5NzY1LC0xNT
