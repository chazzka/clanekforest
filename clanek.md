...
##### Basis step
The only root vertex $r$ is a trivial binary tree with vertices $V_0 = \{r\}$ and edges $$  $T_0= (V_0, E_0) = (\{r\},\emptyset)$. For each $i \in\{1, \dots, n\}$, feature $f_i$ is bounded by the range $r_i$. The ranges form the possibility space $R$ as in (xx). 
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbNTI2MTk5MzM3LDE5NzEyODQzNDAsOTkwNj
